...
@REM ===========================
REM 3. Sleep timeout AC and DC (seconds)
...
@REM ===========================
REM 5. Hibernate timeout AC (disable, command in seconds)
powercfg /change hibernate-timeout-ac 0
powercfg /hibernate off

@REM ===========================
REM 6. Hibernate timeout DC (disable, command in seconds)
powercfg /change hibernate-timeout-dc 3600
powercfg /hibernate off

...
:: ===========================
@echo Immediate automatic download and background installation schedules
...
:: ===========================
@echo Enforces automated installations of minor updates and driver packages
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU" /v "AutoInstallMinorUpdates" /t REG_DWORD /d 1 /f

:: ===========================
@echo Automatic restarts while employees logged on into the operating system
:: NoAutoReboot: 1 = Enforced / No Forced Restart
@echo TODO: Update. Now, this undone the previous settings
...
:: ===========================
@echo Enables and resets the Windows Update background services
sc config wuauserv start= auto
sc stop wuauserv
sc start wuauserv

:: ===========================
@echo Forces an immediate background update detection check
wuauclt /detectnow

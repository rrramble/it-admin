...
:: ==============================================================
echo SECTION 1: Disabling AutoRun policies on 64-bit machines (HKLM)
...
:: ==============================================================
echo SECTION 2: Disabling AutoRun policies for the 32-bit subsystem (Wow6432Node)
...
:: ==============================================================
echo SECTION 3: Disabling the global AutoPlay "Choose what to do" pop-up handlers
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\AutoplayHandlers" /v "DisableAutoplay" /t REG_DWORD /d 1 /f

:: ==============================================================
echo SECTION 4: Injecting AutoRun restrictions into the Default User profile template for future users
...
:: ==============================================================
echo SECTION 5: Injecting AutoRun restrictions into all existing and active user profiles
...
:: ==============================================================
echo SECTION 6: Safe refreshing of Windows environment parameters to apply changes
